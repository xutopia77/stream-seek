    ...
    <div class="detail-panel">
        ...
        <div class="panel-content xc-scrollbar">
            ...
            <template v-else>
                <div class="info-section">
                    ...
                    <div class="info-table">
                        ...
                        <div class="info-row">
                            ...
                            <span class="info-value offset-value">0x{{ box.offset.toString(16).toUpperCase().padStart(8, '0') }}</span>
                        </div>
                    </div>
                </div>

                <div class="info-section" v-if="box.properties && box.properties.length > 0">
                    <h4 class="section-title">{{ t('mediaInfo.boxProperties') }}</h4>
                    <div class="info-table">
                        <div class="info-row" v-for="(prop, index) in box.properties" :key="index">
                ...
                <div class="info-section" v-if="box.children && box.children.length > 0">
                    <h4 class="section-title">{{ t('mediaInfo.childBoxes') }} ({{ box.children.length }})</h4>
                    <div class="children-list">
                        <div
                            class="child-item"
                            v-for="(child, index) in box.children"
                            :key="index"
                        >
...
function getBoxDescription(type: string): string {
    ...
    return BOX_DESCRIPTIONS[trimmedType] || `${type} - 这是一个MP4容器格式的Box结构。MP4文件由一系列Box组成，每个Box包含类型、大小和数据。Box可以嵌套形成树状结构。`
}
